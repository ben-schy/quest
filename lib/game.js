...
const game = {
  ...
  ttsEnabled: true,
  battleBalance: 50,
  newJoiners: new Set(), // player IDs who joined mid-game this round
};
...
function activeChoosers() {
  return [...game.players.values()].filter(p => p.ready && p.hp > 0);
}
...
function resetGameState() {
  ...
  // battleBalance persists across resets (admin preference)
