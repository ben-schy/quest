...
const CHARACTERS = {
  ...
  Nerd: {
    ...
    startingItems: ['Laptop', 'Energy Drink', 'Swiss Army Knife'],
  },
  Dinosaur: {
    blurb: 'Ancient and unstoppable. Enormous strength, limited finesse.',
    hpRange: [38, 52],
    statRanges: { str: [16, 20], dex: [5, 9], int: [4, 7], cha: [8, 13] },
    startingItems: ['Prehistoric Claws', 'Armored Hide', 'Thunderous Roar'],
  },
  'Gym Coach': {
    ...
    startingItems: ["Coach's Whistle", 'Protein Shake', 'Resistance Band'],
  },
  Mom: {
    ...
    startingItems: ['Purse of Holding', 'Wet Wipes', 'Casserole Dish'],
  },
};
